...
let block = { a: 12, b: 20, c: 40 },
	...
	board, key, grid, visual, vMatch, aMatch, vBlock, aBlock, N, olap, seq, delay, wl
...
const audio = new AudioContext(),
	...
	main = () => {
		...
		[btn.right, btn.wrong, run.n] = [0, 0, -1]
	...
	task = () => {
		if (board.classList.contains("task") || $(".result")) { clearSeq(); board.className = ""; return main() }
		prep()
		speak()
